...
# ========================
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    ordered_items = Item.includes(:order_items).where.not(order_items: {id:nil})
    # ---------------------------------------------------------------
...
# ========================
  ...
  it '26. returns the names of items that are associated with one or more orders' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    ordered_items_names = Item.includes(:order_items).where.not(order_items: {id:nil}).distinct.pluck(:name)
    # Solution goes here
